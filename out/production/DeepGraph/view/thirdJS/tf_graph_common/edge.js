        ...
        (function (scene) {
            ...
            (function (edge) {
                ...
                function getLabelForBaseEdge(baseEdge, renderInfo) {
                    ...
                    // console.log("1111111111",shape.map(function (size) { return size === -1 ? '?' : size; })
                ...
                function adjustPathPointsForMarker(points, marker, isStart) {
                    ...
                    // console.log("lineFunc(points)",lineFunc(points));
                ...
                function getEdgePathInterpolator(d, i, a) {
                    ...
                    // console.log("1111111111",points);
                    // console.log("2222222",renderMetaedgeInfo);
