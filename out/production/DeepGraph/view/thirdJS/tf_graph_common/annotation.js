            ...
            (function (annotation_1) {
                ...
                function buildGroup(container, annotationData, d, sceneElement) {
                    ...
                    annotationGroups.enter()
                        ...
                        var edgeType = Class.Annotation.EDGE;
                ...
                function buildShape(aGroup, a) {
                    if (a.annotationType === render.AnnotationType.SUMMARY) {
                        var summary = selectOrCreateChild(aGroup, 'use');
                        summary
                            .attr('class', 'summary')
                        ...
                        var shape = node.buildShape(aGroup, a, Class.Annotation.NODE);
                ...
                function addAnnotationLabel(aGroup, label, a, additionalClassNames) {
                    var classNames = Class.Annotation.LABEL;
                ...
                function addInteraction(selection, d, annotation, sceneElement) {
                    ...
                    if (annotation.annotationType !== render.AnnotationType.SUMMARY &&
                        ...
                        selection.on('contextmenu', contextmenu.getMenu(sceneElement, node.getContextMenu(annotation.node, sceneElement)));
                    }
                }
                ;
                /**
                ...
                function update(aGroup, d, a, sceneElement) {
                    var cx = layout.computeCXPositionOfNodeShape(d);
                    ...
                    if (a.renderNodeInfo &&
                        ...
                        node.stylize(aGroup, a.renderNodeInfo, sceneElement, Class.Annotation.NODE);
                    }
                    if (a.annotationType === render.AnnotationType.SUMMARY) {
                    ...
                    // Edge position
                    aGroup.select('path.' + Class.Annotation.EDGE).transition().attr('d', function (a) {
