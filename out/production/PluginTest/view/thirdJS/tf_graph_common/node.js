        ...
        (function (scene) {
            ...
            (function (node_1) {
                ...
                function buildGroup(sceneGroup, nodeData, sceneElement) {
                    ...
                    //
                    //         console.log("dddddddd",sceneElement._nodeGroupIndex);
                ...
                function subsceneBuild(nodeGroup, renderNodeInfo, sceneElement) {
                    if (renderNodeInfo.node.isGroupNode) {
                        if (renderNodeInfo.expanded) {
                            ...
                            return scene.buildGroup(nodeGroup, renderNodeInfo, sceneElement, Class.Subscene.GROUP);
                        }
                ...
                function subscenePosition(nodeGroup, d) {
                    ...
                    var subscene = scene.selectChild(nodeGroup, 'g', Class.Subscene.GROUP);
                ...
                function addButton(selection, d, sceneElement) {
                    var group = scene.selectOrCreateChild(selection, 'g', Class.Node.BUTTON_CONTAINER);
                ...
                function buildShape(nodeGroup, d, nodeClass) {
                    ...
                    switch (d.node.type) {
                        ...
                        case graph.NodeType.SERIES:
                            ...
                            var classList = [Class.Node.COLOR_TARGET];
                ...
                function getFillForNode(templateIndex, colorBy, renderInfo, isExpanded) {
                    var colorParams = render.MetanodeColors;
                    switch (colorBy) {
                ...
                function stylize(nodeGroup, renderInfo, sceneElement, nodeClass) {
                    ...
                    var isExpanded = renderInfo.expanded && nodeClass !== Class.Annotation.NODE;
                    var isFadedOut = renderInfo.isFadedOut;
                    nodeGroup.classed('highlighted', 1);
                    nodeGroup.classed('selected', 1);
